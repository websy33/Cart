    ...
    <header className="bg-white shadow-sm py-4 px-6">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/Swimwear/wishlist')}
          ...
          <button 
            onClick={() => navigate('/Swimwear/cart')}
...
const Cart = ({ 
  ...
  onClick={() => navigate('/Swimwear/Payment')}
>
  Proceed to Checkout
</button>
