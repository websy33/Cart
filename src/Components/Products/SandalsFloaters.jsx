      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 
            ...
            onClick={() => navigate('/SandalsFloaters')}
          >
            Fashion Store
          </h1>
        </div>
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/SandalsFloaters/wishlist')}
          ...
          <button 
            onClick={() => navigate('/SandalsFloaters/cart')}
...
const SandalsFloaters = () => {
  ...
  const navigateToProductDetail = (productId) => {
    navigate(`/SandalsFloaters/${productId}`);
  };
...
export default SandalsFloaters;