      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 
            ...
            onClick={() => navigate('/FormalTrouser')}
          >
            Fashion Store
          </h1>
        </div>
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/FormalTrouser/wishlist')}
          ...
          <button 
            onClick={() => navigate('/FormalTrouser/cart')}
...
const Cart = ({ 
  ...
  onClick={() => navigate('/FormalTrouser/Payment')}
>
  Proceed to Checkout
</button>
...
const FormalTrouser = () => {
  ...
  const navigateToProductDetail = (productId) => {
    navigate(`/FormalTrouser/${productId}`);
  };
