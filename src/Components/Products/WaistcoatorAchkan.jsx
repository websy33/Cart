      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 
            ...
            onClick={() => navigate('/WaistcoatorAchkan')}
          >
            Fashion Store
          </h1>
        </div>
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/WaistcoatorAchkan/wishlist')}
          ...
          <button 
            onClick={() => navigate('/WaistcoatorAchkan/cart')}
...
const ProductGrid = ({ products, addToCart, toggleWishlist, navigateToProductDetail }) => {
  ...
  const handleAddToCart = (product) => {
    ...
    navigate('/WaistcoatorAchkan/cart');
  };
...
const Cart = ({ 
  ...
  onClick={() => navigate('/WaistcoatorAchkan/Payment')}
>
  Proceed to Checkout
</button>
...
const WaistcoatorAchkan = () => {
  ...
  const navigateToProductDetail = (productId) => {
    navigate(`/WaistcoatorAchkan/${productId}`);
  };
...
export default WaistcoatorAchkan;