      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 
            ...
            onClick={() => navigate('/SunglassesFrames')}
          >
            Fashion Store
          </h1>
        </div>
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/SunglassesFrames/wishlist')}
          ...
          <button 
            onClick={() => navigate('/SunglassesFrames/cart')}
...
const ProductGrid = ({ products, addToCart, toggleWishlist, navigateToProductDetail }) => {
  ...
  const handleAddToCart = (product) => {
    ...
    navigate('/SunglassesFrames/cart');
  };
...
const SunglassesFrames = () => {
  ...
  const navigateToProductDetail = (productId) => {
    navigate(`/SunglassesFrames/${productId}`);
  };
...
export default SunglassesFrames;