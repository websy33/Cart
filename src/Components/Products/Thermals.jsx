    ...
    <header className="bg-white shadow-sm py-4 px-6">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/Thermals/wishlist')}
          ...
          <button 
            onClick={() => navigate('/Thermals/cart')}
...
const Cart = ({ 
  ...
  onClick={() => navigate('/Thermals/Payment')}
>
  Proceed to Checkout
</button>
