      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 
            ...
            onClick={() => navigate('/SleepwearLoungewear')}
          >
            Fashion Store
          </h1>
        </div>
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/SleepwearLoungewear/wishlist')}
          ...
          <button 
            onClick={() => navigate('/SleepwearLoungewear/cart')}
...
const ProductGrid = ({ products, addToCart, toggleWishlist, navigateToProductDetail }) => {
  ...
  const handleAddToCart = (product) => {
    ...
    navigate('/SleepwearLoungewear/cart');
  };
...
export default SleepwearLoungewear;