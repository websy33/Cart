    ...
    <header className="bg-white shadow-sm py-4 px-6">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/Rainjackets/wishlist')}
          ...
          <button 
            onClick={() => navigate('/Rainjackets/cart')}
...
const Cart = ({ 
  ...
  onClick={() => navigate('/Rainjackets/Payment')}
>
  Proceed to Checkout
</button>
...
const Rainjackets = () => {
  ...
  const navigateToProductDetail = (productId) => {
    navigate(`/Rainjackets/${productId}`);
  };
