      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 
            ...
            onClick={() => navigate('/SportsSandles')}
          >
            Fashion Store
          </h1>
        </div>
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/SportsSandles/wishlist')}
          ...
          <button 
            onClick={() => navigate('/SportsSandles/cart')}
...
const Cart = ({ 
  ...
  onClick={() => navigate('/SportsSandles/Payment')}
>
  Proceed to Checkout
</button>
...
const SportsSandles = () => {
  ...
  const navigateToProductDetail = (productId) => {
    navigate(`/SportsSandles/${productId}`);
  };
