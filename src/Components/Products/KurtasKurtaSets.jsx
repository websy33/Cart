      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 
            ...
            onClick={() => navigate('/KurtasKurtaSets')}
          >
            Fashion Store
          </h1>
        </div>
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/KurtasKurtaSets/wishlist')}
          ...
          <button 
            onClick={() => navigate('/KurtasKurtaSets/cart')}
...
const Cart = ({ 
  ...
  onClick={() => navigate('/KurtasKurtaSets/Payment')}
>
  Proceed to Checkout
</button>
...
const KurtasKurtaSets = () => {
  ...
  const navigateToProductDetail = (productId) => {
    navigate(`/KurtasKurtaSets/${productId}`);
  };
...
export default KurtasKurtaSets;