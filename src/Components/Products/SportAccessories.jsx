      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 
            ...
            onClick={() => navigate('/SportAccessories')}
          >
            Fashion Store
          </h1>
        </div>
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/SportAccessories/wishlist')}
          ...
          <button 
            onClick={() => navigate('/SportAccessories/cart')}
...
const Cart = ({ 
  ...
  onClick={() => navigate('/SportAccessories/Payment')}
>
  Proceed to Checkout
</button>
...
const SportAccessories = () => {
  ...
  const navigateToProductDetail = (productId) => {
    navigate(`/SportAccessories/${productId}`);
  };
