      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 
            ...
            onClick={() => navigate('/JacketsSweatshirts')}
          >
            Fashion Store
          </h1>
        </div>
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/JacketsSweatshirts/wishlist')}
          ...
          <button 
            onClick={() => navigate('/JacketsSweatshirts/cart')}
...
const ProductGrid = ({ products, addToCart, toggleWishlist, navigateToProductDetail }) => {
  ...
  const handleAddToCart = (product) => {
    ...
    navigate('/JacketsSweatshirts/cart');
  };
...
const JacketsSweatshirts = () => {
  ...
  const navigateToProductDetail = (productId) => {
    navigate(`/JacketsSweatshirts/${productId}`);
  };
...
export default JacketsSweatshirts;