      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 
            ...
            onClick={() => navigate('/TrackPantsShirts')}
          >
            Fashion Store
          </h1>
        </div>
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/TrackPantsShirts/wishlist')}
          ...
          <button 
            onClick={() => navigate('/TrackPantsShirts/cart')}
...
const ProductGrid = ({ products, addToCart, toggleWishlist, navigateToProductDetail }) => {
  ...
  const handleAddToCart = (product) => {
    ...
    navigate('/TrackPantsShirts/cart');
  };
...
const Cart = ({ 
  ...
  onClick={() => navigate('/TrackPantsShirts/Payment')}
>
  Proceed to Checkout
</button>
...
const TrackPantsShirts = () => {
  ...
  const navigateToProductDetail = (productId) => {
    navigate(`/TrackPantsShirts/${productId}`);
  };
...
export default TrackPantsShirts;