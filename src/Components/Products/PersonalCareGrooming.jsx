      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 
            ...
            onClick={() => navigate('/PersonalCareGrooming')}
          >
            Fashion Store
          </h1>
        </div>
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/PersonalCareGrooming/wishlist')}
          ...
          <button 
            onClick={() => navigate('/PersonalCareGrooming/cart')}
...
const ProductGrid = ({ products, addToCart, toggleWishlist, navigateToProductDetail }) => {
  ...
  const handleAddToCart = (product) => {
    ...
    navigate('/PersonalCareGrooming/cart');
  };
...
const Cart = ({ 
  ...
  onClick={() => navigate('/Tshirt/Payment')}
>
  Proceed to Checkout
</button>
...
const PersonalCareGrooming = () => {
  ...
  const navigateToProductDetail = (productId) => {
    navigate(`/PersonalCareGrooming/${productId}`);
  };
...
export default PersonalCareGrooming;