      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 
            ...
            onClick={() => navigate('/TrackPantsJoggers')}
          >
            Fashion Store
          </h1>
        </div>
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/TrackPantsJoggers/wishlist')}
          ...
          <button 
            onClick={() => navigate('/TrackPantsJoggers/cart')}
...
const ProductGrid = ({ products, addToCart, toggleWishlist, navigateToProductDetail }) => {
  ...
  const handleAddToCart = (product) => {
    ...
    navigate('/TrackPantsJoggers/cart');
  };
...
const TrackPantsJoggers = () => {
  ...
  const navigateToProductDetail = (productId) => {
    navigate(`/TrackPantsJoggers/${productId}`);
  };
...
export default TrackPantsJoggers;