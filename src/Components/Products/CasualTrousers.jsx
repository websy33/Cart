      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 
            ...
            onClick={() => navigate('/CasualTrousers')}
          >
            Fashion Store
          </h1>
        </div>
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/CasualTrousers/wishlist')}
          ...
          <button 
            onClick={() => navigate('/CasualTrousers/cart')}
...
const Cart = ({ 
  ...
  onClick={() => navigate('/CasualTrousers/Payment')}
>
  Proceed to Checkout
</button>
...
const CasualTrousers = () => {
  ...
  const navigateToProductDetail = (productId) => {
    navigate(`/CasualTrousers/${productId}`);
  };
