      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 
            ...
            onClick={() => navigate('/TurbanorSkullCap')}
          >
            Fashion Store
          </h1>
        </div>
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/TurbanorSkullCap/wishlist')}
          ...
          <button 
            onClick={() => navigate('/TurbanorSkullCap/cart')}
...
const Cart = ({ 
  ...
  onClick={() => navigate('/TurbanorSkullCap/Payment')}
>
  Proceed to Checkout
</button>
...
const TurbanorSkullCap = () => {
  ...
  const navigateToProductDetail = (productId) => {
    navigate(`/TurbanorSkullCap/${productId}`);
  };
...
export default TurbanorSkullCap;