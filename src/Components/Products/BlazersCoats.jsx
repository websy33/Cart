    ...
    <header className="bg-white shadow-sm py-4 px-6">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/BlazersCoats/wishlist')}
          ...
          <button 
            onClick={() => navigate('/BlazersCoats/cart')}
...
const Cart = ({ 
  ...
  onClick={() => navigate('/BlazersCoats/Payment')}
>
  Proceed to Checkout
</button>
...
const BlazersCoats = () => {
  ...
  const navigateToProductDetail = (productId) => {
    navigate(`/BlazersCoats/${productId}`);
  };
