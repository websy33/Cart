    ...
    <header className="bg-white shadow-sm py-4 px-6">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex space-x-6">
          <button 
            onClick={() => navigate('/SportsShoes/wishlist')}
          ...
          <button 
            onClick={() => navigate('/SportsShoes/cart')}
...
const Cart = ({ 
  ...
  onClick={() => navigate('/SportsShoes/Payment')}
>
  Proceed to Checkout
</button>
...
const SportsShoes = () => {
  ...
  const navigateToProductDetail = (productId) => {
    navigate(`/SportsShoes/${productId}`);
  };
